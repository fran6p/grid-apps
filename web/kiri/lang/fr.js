...
kiri.lang['fr-fr'] = {
    ...
    files:          "fichiers",
    help:           "aide",
    ghost:          "silhouette",  // left render pop menu (wireframe)
    ...
    reset:          "réinitialiser",
    rotate:         "orienter",      // left rotate pop menu
    save:           "sauvegarder",
    ...
    dm_appp:        "Préférences de l'application",
    ...
    op_decl_s:      "logos",
    op_decl_l:      "montrer les logos des matériels",
    op_dang_s:      "expérimental",
    op_dang_l:      "afficher les paramètres expérimentaux",
    ...
    op_shru_l:      ["afficher les règles des axes", "sur le quadrillage"],
    op_sped_s:      "afficher les vitesses",
    op_sped_l:      ["afficher la vitesse en barres de couleur","en mode prévisualisation"],
    op_auto_s:      "disposition automatique",
    op_auto_l:      ["disposer automatiquement sur le plateau", "lors d'ajouts de nouveaux éléments"],
    op_free_s:      "disposition libre",
    op_free_l:      ["autoriser la disposition libre","sans effet en mode laser"],
    op_spcr_s:      "espacement",
    op_spcr_l:      ["espacement entre les objets", "avec la disposition automatique", "en unités d'espace de travail"],
    op_orth_s:      "orthogonal",
    op_orth_l:      ["affichage orthogonal","rafraichissement de la page requis"],
    ...
    pt_heal_l:      ["tenter de corriger", "les mailles non-fermées", "accroit le temps de tranchage"],
    ...
    // FDM SHELLS
    sl_shel_s:      "parois",
    sl_shel_l:      ["nombre de périmètres", "parois à générer"],
    ...
    fl_lahi_l:      ["hauteur de chaque couche", "en millimètres", ">= hauteur de la couche"],
    fl_rate_s:      "vitesse périmètres",
    fl_rate_l:      ["vitesse maximale d'impression des coques", "en millimètres / secondes"],
    fl_frat_s:      "vitesse remplissage",
    fl_frat_l:      ["vitesse maximale d'impression du remplissage", "en millimètres / secondes"],
    fl_mult_s:      "débit",
    ...
    fl_brmn_l:      ["ajout de bordures uniquement quand le segment", "face à la bande est plus court que cette valeur", "en millimètres, 0 = infini"],
    ...
    sp_detect:      "détecter",
    sp_dens_s:      "densité",
    sp_dens_l:      ["fraction 0.0 - 1.0","recommandé 0.15","0 désactive"],
    ...
    sp_span_s:      "surplomb maximal",
    sp_span_l:      ["surplomb non soutenu nécessitant", "un nouveau soutien à générer","en millimètres"],
    sp_angl_s:      "angle max",
    ...
    sp_auto_l:      ["activer la génération de supports", "utilise la géométrie au moment du tranchage", "les supports n'apparaîtront", "qu'une fois le tranchage terminé"],
    ...
    ou_bedd_s:      "température du plateau",
    ou_bedd_l:      "degrés en celsius",
    ou_feed_s:      "vitesse d'impression",
    ou_feed_l:      ["vitesse d'impression maximale","millimètres / secondes"],
    ou_fini_s:      "vitesse de coque",
    ou_fini_l:      ["vitesse de la coque extérieure","millimètres / secondes"],
    ou_move_s:      "vitesse de déplacement",
    ou_move_l:      ["vitesse de déplacement sans impression","millimètres / secondes","0 = active déplacements G0"],
